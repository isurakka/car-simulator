...
namespace CarSimulator
{
    public static class BodyRenderer
    {
            ...
            Color? color = null, Color? outlineColor = null)
        {
            switch (shape.ShapeType)
            {
                ...
                case ShapeType.Circle:
                {
                    ...
                    drawCircle(ref tf, target, circle, states ?? RenderStates.Default, color ?? Color.White, outlineColor);
                }
                    break;
                case ShapeType.Edge:
                    break;
            ...
            Color color, Color? outlineColor = null)
        {
            ...
            target.Draw(
                new SFML.Graphics.CircleShape(radius, (uint)(radius * 3f))
                {
                    Origin = new Vector2f(radius, radius),
                    Position = pos,
                    Rotation = rot,
                    FillColor = color,
                    OutlineThickness = outlineColor != null ? outlineThickness : 0f,
